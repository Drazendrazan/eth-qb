...
//     document.getElementById('healthValue').value = JSON.parse(localStorage.getItem("healthV"))? JSON.parse(localStorage.getItem("healthV")):95;
//     document.getElementById('armorValue').value = JSON.parse(localStorage.getItem("armorV"))? JSON.parse(localStorage.getItem("armorV")):95;
//     document.getElementById('hungerValue').value = JSON.parse(localStorage.getItem("hungerV"))? JSON.parse(localStorage.getItem("hungerV")):95;
//     document.getElementById('thirstValue').value = JSON.parse(localStorage.getItem("thirstV"))? JSON.parse(localStorage.getItem("thirstV")):95;
...
window.addEventListener('message', function(event){
    ...
    if (data.action == "update") {
        ...
        if (data.nitroActive == "true") {
            $("#nos").attr("stroke", "#D64763");
        } else if (data.nitroActive == "false") {
            $("#nos").attr("stroke", "#FFFFFF");
        }
...
$(document).on('click', '#save-button', function (e) {
    ...
    // localStorage.setItem("healthV", JSON.stringify(document.getElementById('healthValue').value))
    // localStorage.setItem("armorV", JSON.stringify(document.getElementById('armorValue').value))
    // localStorage.setItem("hungerV", JSON.stringify(document.getElementById('hungerValue').value))
    // localStorage.setItem("thirstV", JSON.stringify(document.getElementById('thirstValue').value))
...
const inputSvg = document.querySelectorAll('.MuiIconButton-root .MuiSvgIcon-root > path');

for (let i = 0; i < checkboxs.length; i++) {
    checkboxs[i].addEventListener('change', function() {
        if (inputSvg[i]) { // inputSvg[i] undefined değilse işlem yap
