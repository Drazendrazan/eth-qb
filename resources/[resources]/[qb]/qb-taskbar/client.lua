...
local function hasPhone()
  return exports["lj-inventory"]:hasEnoughOfItem("mobilephone", 1, false, true) or
      exports["lj-inventory"]:hasEnoughOfItem("stoleniphone", 1, false, true) or
      exports["lj-inventory"]:hasEnoughOfItem("stolens8", 1, false, true) or
      exports["lj-inventory"]:hasEnoughOfItem("stolennokia", 1, false, true) or
      exports["lj-inventory"]:hasEnoughOfItem("stolenpixel3", 1, false, true) or
      exports["lj-inventory"]:hasEnoughOfItem("boomerphone", 1, false, true)
end
...
local function hasVPN()
  return exports["lj-inventory"]:hasEnoughOfItem("vpnxj", 1, false, true)
end
