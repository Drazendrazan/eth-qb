...
AddEventHandler("qb-paintball:getPaintballAmmos", function()
    ...
    player.Functions.AddItem('paintball-ammo', 5)
    TriggerClientEvent('inventory:client:ItemBox', source, QBCore.Shared.Items['paintball-ammo'], "add", 5)

end)

RegisterServerEvent("qb-paintball:getPaintballSmokes")
AddEventHandler("qb-paintball:getPaintballSmokes", function()
    local src = source
    local player = QBCore.Functions.GetPlayer(source)

    player.Functions.AddItem('weapon_smokegrenade', 1)
    TriggerClientEvent('inventory:client:ItemBox', source, QBCore.Shared.Items['weapon_smokegrenade'], "add")
