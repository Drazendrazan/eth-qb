...
function QBCore.Player.CheckPlayerData(source, PlayerData)
    ...
    -- PlayerData.metadata['health'] = PlayerData.metadata['health'] or 15
...
RegisterServerEvent('qb-core:updatecoords')
AddEventHandler('qb-core:updateCoords', function(x,y,z)
    local src = source
    pos[src] = {x,y,z}
end)
