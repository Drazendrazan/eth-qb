...
function isPed(checkType)
    ...
    if checkType == "counthunting" then
      pass = curHunting
  end
...
AddEventHandler("job:counts", function(activePolice,activeEms,activeTaxi,activeTow, activeDoctors, activeHunting)
