...
local pEntity = exports['eth-callbacks']:GetCurrentEntity() 
local PlayerJob = {}
Config = {}
...
rootMenuConfig =  {
...

    {
        ...
        enableMenu = function()
            local pData = QBCore.Functions.GetPlayerData()
            return (not pData.metadata["isdead"] and inPdMech and isPolice and onDuty  and IsPedInAnyVehicle(PlayerPedId(), false))
        end
    },
    -- {
    --     id = "GiveCarKeys",
...
CreateThread(function()
    for k, v in pairs(Garages) do 
        exports["ps-zones"]:CreateBoxZone("garages"..k, vector3(Garages[k].polyzone.x, Garages[k].polyzone.y, Garages[k].polyzone.z), Garages[k].polyzone1, Garages[k].polyzone2, {
            debugPoly = false,
    ...
    for k, v in pairs(GangGarages) do
        exports["ps-zones"]:CreateBoxZone("ganggarages"..k,  vector3(GangGarages[k].polyzone.x, GangGarages[k].polyzone.y, GangGarages[k].polyzone.z), GangGarages[k].polyzone1, GangGarages[k].polyzone2, {
            debugPoly = false,
    ...
    for k, v in pairs(JobGarages) do
        exports["ps-zones"]:CreateBoxZone("jobgarages"..k,  vector3(JobGarages[k].polyzone.x, JobGarages[k].polyzone.y, JobGarages[k].polyzone.z), JobGarages[k].polyzone1, JobGarages[k].polyzone2, {
            debugPoly = false,
    ...
    for k, v in pairs(Depots) do
        exports["ps-zones"]:CreateBoxZone("depots"..k, vector3(Depots[k].polyzone.x, Depots[k].polyzone.y, Depots[k].polyzone.z), Depots[k].polyzone1, Depots[k].polyzone2, {
            debugPoly = false,
...
CreateThread(function()
    exports["ps-zones"]:CreateBoxZone("Bennys", vector3(-39.1, -1053.51, 28.4), 6.8, 4.8, {
        debugPoly = false,
        heading = 339,
        minZ = 27.4,
        maxZ = 31.2
    ...
    exports["ps-zones"]:CreateBoxZone("Bennys2", vector3(-221.75, -1329.9, 30.89), 4.2, 7.4, {
        debugPoly = false,
        heading = 0,
        minZ = 29.89,
        maxZ = 32.49
    ...
    exports["ps-zones"]:CreateBoxZone("TunerRepair", vector3(125.07, -3041.25, 7.08), 3.2, 6.4, {
        debugPoly = false,
        heading = 0,
        minZ = 6.08,
        maxZ = 8.88
    ...
    exports["ps-zones"]:CreateBoxZone("TunerShop", vector3(144.94, -3030.44, 7.04), 6.2, 3.6, {
        debugPoly = false,
        heading = 0,
        minZ = 6.04,
        maxZ = 8.04
    ...
    exports["ps-zones"]:CreateBoxZone("HayesAutos", vector3(-1417.38, -446.39, 36.07), 7.2, 3.6, {
        debugPoly = false,
        heading = 212,
        minZ = 34.07,
        maxZ = 36.87
    ...
    -- exports["qb-polyzone"]:AddBoxZone("pdmech", vector3(452.36337, -977.3203, 25.031999), 10, 12.8, {
    --     name="pdmech",
    --     heading=0,
    --     debugPoly = true,
    --     minZ = 20.7,
    ...
    exports["ps-zones"]:CreateBoxZone("SandyRepair", vector3(1182.56, 2640.36, 37.76), 7.8, 4.0, {
        debugPoly = false,
        heading = 0,
        minZ = 36.76,
        maxZ = 39.36
    ...
    exports["ps-zones"]:CreateBoxZone("PaletoRepair", vector3(111.42, 6627.03, 31.79), 8.4, 4.6, {
        debugPoly = false,
        heading = 43,
        minZ = 30.79,
        maxZ = 33.39
    ...
    exports["ps-zones"]:CreateBoxZone("Ottos", vector3(832.39, -805.53, 26.33), 4.2, 6.2, {
        debugPoly = false,
        heading = 0.0,
        minZ=25.33,
        maxZ=27.93
    ...
    exports["ps-zones"]:CreateBoxZone("towFinance", vector3(-239.42, -1183.79, 23.04), 4.2, 9.0, {
        debugPoly = false,
        heading = 0.0,
        minZ=21.64,
        maxZ=25.64
    ...
    exports["ps-zones"]:CreateBoxZone("pdmech", vector3(452.02, -975.89, 25.7), 4.4, 12.8, {
        debugPoly = false,
        heading = 0.0,
        minZ = 24.7,
        maxZ = 27.5
...
RegisterNetEvent("ps-zones:enter", function(name, ZoneData)
    local InVehicle = IsPedInAnyVehicle(PlayerPedId())
    if string.find(name, "garages") then
        inGarage = true
        exports['qb-ui']:showInteraction('Parking')
    elseif string.find(name, "ganggarages") then
        inGarage = true
        exports['qb-ui']:showInteraction('Parking')
    elseif string.find(name, "jobgarages") then
        inGarage = true
        exports['qb-ui']:showInteraction('Parking')
    elseif string.find(name, "depots") then
        inDepots = true
...
RegisterNetEvent("ps-zones:leave", function(name, ZoneData)
    if string.find(name, "garages") then
        inGarage = false
