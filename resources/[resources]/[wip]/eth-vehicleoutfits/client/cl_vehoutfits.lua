...
--[[ RegisterUICallback("qb-ui:car-clothing:swapCurrentOutfit", function(data, cb)
  ...
  AddEventHandler("np-car-clothing:swapCurrentOutfit", function(p1, pEntity)
    exports["qb-ui"]:openApplication("textbox", {
      callbackUrl = "qb-ui:car-clothing:swapCurrentOutfit",
      key = pEntity,
      items = {
        {
          label = "Slot",
...
AddEventHandler("np-car-clothing:saveCurrentOutfit", function(p1, pEntity, p3)
    exports["qb-ui"]:openApplication("textbox", {
      callbackUrl = "qb-ui:car-clothing:saveCurrentOutfit",
      key = pEntity,
      items = {
