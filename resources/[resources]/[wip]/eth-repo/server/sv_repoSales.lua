...
QBCore.Functions.CreateCallback("tp_repocarsales:retrieveVehicles", function(source, cb)
	local src = source
	local identifier = QBCore.Functions.GetPlayer(source)
...
QBCore.Functions.CreateCallback("tp_repocarsales:isVehicleValid", function(source, cb, vehicleProps, price)
	local src = source
...
QBCore.Functions.CreateCallback("tp_repocarsales:buyVehicle", function(source, cb, vehProps, price)
	local src = source
	local xPlayer = QBCore.Functions.GetPlayer(source)
...
QBCore.Functions.CreateCallback("tp_repocarsales:removeVehicleLG", function(source, cb, vehProps, price)
	local src = source
	local xPlayer = QBCore.Functions.GetPlayer(source)
	local price = price
	local plate = vehProps["plate"]
...
function UpdateCash(identifier, cash)
	...
	if xPlayer ~= nil then
		...
		TriggerClientEvent("notify:sendNotification", {text = 'someone bought your vehicle for '.. cash ..':-', layout = "centerLeft", timeout = 5000, type = 'success', progressBar = true, theme = 'lg', animation = {open = "gta_effects_fade_in", close = "gta_effects_fade_out"}})
