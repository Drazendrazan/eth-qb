...
function StartTransmission()
    ...
    if not IsTalkingOnRadio then
        ...
        TriggerEvent("eth:voice:transmissionStarted", { radio = true })
...
function LoadRadioModule()
    ...
    exports["eth-callbacks"]:registerKeyMapping("", "Radio", "Push-To-Talk", "+transmitToRadio", "-transmitToRadio", "CAPITAL")
    RegisterCommand("+transmitToRadio", StartTransmission, false)
    RegisterCommand("-transmitToRadio", StopTransmission, false)

    exports["eth-callbacks"]:registerKeyMapping("", "Radio", "Push-To-Talk (Secondary)", "+secondaryTransmitToRadio", "-secondaryTransmitToRadio")
    ...
    exports["eth-callbacks"]:registerKeyMapping("", "Radio", "Volume Up", "+increaseRadioVolume", "-increaseRadioVolume")
    RegisterCommand("+increaseRadioVolume", IncreaseRadioVolume, false)
    RegisterCommand("-increaseRadioVolume", function() end, false)

    exports["eth-callbacks"]:registerKeyMapping("", "Radio", "Volume Down", "+decreaseRadioVolume", "-decreaseRadioVolume")
    RegisterCommand("+decreaseRadioVolume", DecreaseRadioVolume, false)
    RegisterCommand("-decreaseRadioVolume", function() end, false)

    exports["eth-callbacks"]:registerKeyMapping("", "Radio", "On / Off", "+toggleRadioState", "-toggleRadioState")
    ...
    exports["eth-callbacks"]:registerKeyMapping("", "Radio", "Channel Up", "+increaseRadioChannel", "-increaseRadioChannel")
    RegisterCommand("+increaseRadioChannel", increaseRadioChannel, false)
    RegisterCommand("-increaseRadioChannel", function() end, false)

    exports["eth-callbacks"]:registerKeyMapping("", "Radio", "Channel Down", "+decreaseRadioChannel", "-decreaseRadioChannel")
    RegisterCommand("+decreaseRadioChannel", decreaseRadioChannel, false)
    RegisterCommand("-decreaseRadioChannel", function() end, false)

    RegisterNetEvent("eth:voice:radio:connect")
    AddEventHandler("eth:voice:radio:connect", ConnectToRadio)

    RegisterNetEvent("eth:voice:radio:disconnect")
    AddEventHandler("eth:voice:radio:disconnect", DisconnectFromRadio)

    RegisterNetEvent("eth:voice:radio:added")
    AddEventHandler("eth:voice:radio:added", AddRadioSubscriber)

    RegisterNetEvent("eth:voice:radio:removed")
    AddEventHandler("eth:voice:radio:removed", RemoveRadioSubscriber)

    RegisterNetEvent("eth:voice:radio:power")
    AddEventHandler("eth:voice:radio:power", SetRadioPowerState)

    RegisterNetEvent("eth:voice:radio:volume")
    AddEventHandler("eth:voice:radio:volume", SetRadioVolume)
    ...
    TriggerEvent("eth:voice:radio:ready")
