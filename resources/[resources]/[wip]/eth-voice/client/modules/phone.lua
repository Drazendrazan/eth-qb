...
function LoadPhoneModule()
    ...
    RegisterNetEvent("eth:voice:phone:call:start")
    AddEventHandler("eth:voice:phone:call:start", StartPhoneCall)

    RegisterNetEvent("eth:voice:phone:call:end")
    AddEventHandler("eth:voice:phone:call:end", StopPhoneCall)
    ...
    TriggerEvent("eth:voice:phone:ready")

    Debug("[Phone] Module Loaded")
end

RegisterNetEvent("eth-voice:setTransmissionDisabled", function ()
    WasEventCanceled()
