...
function ConnectToATCFrequency()
    local subscribers = RPC.execute("eth-voice:atc:subscribe")
...
function DisconnectFromATCFrequency()
    ...
    RPC.execute("eth-voice:atc:unsubscribe")
...
function LoadATCModule()
    ...
    exports["eth-callbacks"]:registerKeyMapping("", "ATC", "Push-To-Talk", "+transmitToATCRadio", "-transmitToATCRadio")
    ...
    exports["eth-callbacks"]:registerKeyMapping("", "ATC", "On / Off", "+toggleATCRadioState", "-toggleATCRadioState")
    ...
    exports["eth-callbacks"]:registerKeyMapping("", "ATC", "Volume Up", "+increaseATCRadioVolume", "-increaseATCRadioVolume")
    ...
    exports["eth-callbacks"]:registerKeyMapping("", "ATC", "Volume Down", "+decreaseATCRadioVolume", "-decreaseATCRadioVolume")
    ...
    RegisterNetEvent("eth-voice:atc:connect", ConnectToATCFrequency)

    RegisterNetEvent("eth-voice:atc:disconnect", DisconnectFromATCFrequency)

    RegisterNetEvent("eth-voice:atc:setPowerState", SetATCRadioPowerState)

    RegisterNetEvent("eth-voice:atc:addSubscriber", AddATCSubscriber)

    RegisterNetEvent("eth-voice:atc:removeSubscriber", RemoveATCSubscriber)
